...
?>
        ...
        if (isset($_POST["submit"])) {
            ...
            // Validate input (you can implement validation functions here if needed)
            ...
            if ($stmt) {
                $outpassstatus = 0; // Assuming outpass status is initially set to 0 (pending)
                $exitdate = $fromtime;
                $returndate = $totime;
                $outpassdescription = $reason;

                // Bind parameters
                $stmt->bind_param("iiisss", $inmateid, $outpassstatus, $exitdate, $returndate, $outpassdescription, $place);
        ...
        <body>
            ...
            <header>
                ...
                <div class="message">
                    ...
                    <div class="dp">
                        <img src="https://media.geeksforgeeks.org/wp-content/uploads/20221210180014/profile-removebg-preview.png" class="dpicn" style=" height: 42px;" alt="dp">
